...
|------|------|-------------------------------------------|-------------|-------------|
| 0-1  | 2    | Scan pointer                              | uint16      | <details> <summary>Details</summary> A 16-bit unsigned integer incremented with each measurement to uniquely identify the scan. </details> |
| 2    | 1    | Total messages                            | uint8       | <details> <summary>Details</summary> A single unsigned byte indicating the total number of uplink messages expected for this scan. </details> 
| 3    | 1    | #Message                                  | uint8       | <details> <summary>Details</summary> The current message number in the sequence of uplinks. </details> 
|4-9   | 6    | Mac1                                      | 6 x uint8   |
| 10   | 1    | Rssi1                                     | int8        |
|      |      | …                                         |             |
|      | 6    | MacN                                      | 6 x uint8   | <details> <summary>Details</summary> MAC address of the detected BLE beacon(s), represented as six unsigned bytes. </details> 
|      | 1    | RssiN                                     | int8        | <details> <summary>Details</summary> Signal strength (RSSI) of the respective BLE beacon, represented as a signed byte. </details>
