...
|------|------|-------------------------------------------|-------------|
| 0-1  | 2    | Scan Pointer     [<img src="/img/tooltip.webp" width="2.5%"/>](## "A 16-bit unsigned integer incremented with each measurement to uniquely identify the scan.")                        | uint16      |
