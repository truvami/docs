...
| Byte | Size | Description                                                                                                                               | Format |
| ---- | ---- | ----------------------------------------------------------------------------------------------------------------------------------------- | ------ |
| 0    | 1    | <details> <summary>Enable/disable buzzer feedback</summary> Enable or disable buzzer feedback upon magnet interaction (0 = disable, 1 = enable). </details> | uint8  |
...
|2|1|hdop|unit8, 0.1 granularity, [0..25.5]|5.0|
